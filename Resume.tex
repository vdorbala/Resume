...
\name{Vishnu Sashank Dorbala} % Your name
\address{Website: \href{https://vdorbala.github.io}{https://vdorbala.github.io}} % Your address
%\address{123 Pleasant Lane \\ City, State 12345} % Your secondary addess (optional)
\address{(+91)7743875800 \\ \href{mailto:vdorbala@gmail.com}{vdorbala@gmail.com}} % Your phone number and email
...
% {\textbullet \hspace{0.1em} \textbf{Extra-Curricular Activities}}

% \vspace*{-0.2em}
% \begin{list}{$\cdot$}{\leftmargin=1.2em}
% \itemsep0em 
% \item Conducted a workshop in IIIT-H's Computer Vision Summer School on 3D Vision and Structure for Motion. Created assignments to evaluate the participants' performance.
% \item Designed and organized a hackathon on "Autonomous Navigation" for an AI/ML course for industry professionals held on campus. Used Gazebo to create simulations of an obstacle course. Wrote template code for the participants to plug in their CNN models for using images of signboards to autonomously navigate the track.
% \end{list}
